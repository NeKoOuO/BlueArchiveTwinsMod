...
//
//public class BATwinsGeneralMedicine extends CustomPotion {
//    public static final String ID = ModHelper.makePath("GeneralMedicine");
...
//    private static final String imgUrl = ModHelper.makeImgPath("UI/soraShop", "medicine");
