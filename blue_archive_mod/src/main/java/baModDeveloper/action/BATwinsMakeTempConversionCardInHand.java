...
//
//public class BATwinsMakeTempConversionCardInHand extends AbstractGameAction {
//    private AbstractCard c;
//    private static final float PADDING;
//    private boolean isOtherCardInCenter;
//    private boolean sameUUID;
//    private AbstractCard.CardColor conversionColor;
//
//    public BATwinsMakeTempConversionCardInHand(AbstractCard card, boolean isOtherCardInCenter) {
...
//    }
//
//    public BATwinsMakeTempConversionCardInHand(AbstractCard card) {
//        this(card, 1);
//    }
//
//    public BATwinsMakeTempConversionCardInHand(AbstractCard card, int amount) {
//        this.isOtherCardInCenter = true;
//        this.sameUUID = false;
//        UnlockTracker.markCardAsSeen(card.cardID);
//        this.amount = amount;
...
//    }
//
//    public BATwinsMakeTempConversionCardInHand(AbstractCard card, int amount, boolean isOtherCardInCenter) {
//        this(card, amount);
//        this.isOtherCardInCenter = isOtherCardInCenter;
//    }
//
//    public BATwinsMakeTempConversionCardInHand(AbstractCard card, boolean isOtherCardInCenter, boolean sameUUID) {
//        this(card, 1);
//        this.isOtherCardInCenter = isOtherCardInCenter;
//        this.sameUUID = sameUUID;
//    }
//    public BATwinsMakeTempConversionCardInHand(AbstractCard card, AbstractCard.CardColor conversionColor){
//        this(card);
